#############################################################################
# Makefile for building: apertus_challenge
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  ../apertus_challenge/apertus_challenge.pro
# Template: app
# Command: /home/anirudh/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../apertus_challenge/apertus_challenge.pro
#############################################################################
...
INCPATH       = -I../apertus_challenge -I. -I../../Qt5.7.0/5.7/gcc_64/include -I../../Qt5.7.0/5.7/gcc_64/include/QtCore -I. -I../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
QMAKE         = /home/anirudh/Qt5.7.0/5.7/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = apertus_challenge1.0.0
DISTDIR = /home/anirudh/qt_projects/build-apertus_challenge-Desktop_Qt_5_7_0_GCC_64bit-Debug/.tmp/apertus_challenge1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/anirudh/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/anirudh/Qt5.7.0/5.7/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../apertus_challenge/main.cpp \
		../apertus_challenge/lodepng.cpp \
		../apertus_challenge/debayer.cpp qrc_myres.cpp
OBJECTS       = main.o \
		lodepng.o \
		debayer.o \
		qrc_myres.o
DIST          = ../apertus_challenge/portrait-gainx2-offset2047-20ms-02.raw12 \
		...
		../apertus_challenge/apertus_challenge.pro ../apertus_challenge/lodepng.h \
		../apertus_challenge/debayer.h ../apertus_challenge/main.cpp \
		../apertus_challenge/lodepng.cpp \
		../apertus_challenge/debayer.cpp
QMAKE_TARGET  = apertus_challenge
DESTDIR       = 
...
Makefile: ../apertus_challenge/apertus_challenge.pro ../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt5.7.0/5.7/gcc_64/mkspecs/features/yacc.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/features/lex.prf \
		../apertus_challenge/apertus_challenge.pro \
		../apertus_challenge/myres.qrc \
		../../Qt5.7.0/5.7/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../apertus_challenge/apertus_challenge.pro
../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf:
../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf:
../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf:
../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../apertus_challenge/myres.qrc $(DISTDIR)/
	$(COPY_FILE) --parents ../apertus_challenge/lodepng.h ../apertus_challenge/debayer.h $(DISTDIR)/
	$(COPY_FILE) --parents ../apertus_challenge/main.cpp ../apertus_challenge/lodepng.cpp ../apertus_challenge/debayer.cpp $(DISTDIR)/
...
qrc_myres.cpp: ../apertus_challenge/myres.qrc \
		../../Qt5.7.0/5.7/gcc_64/bin/rcc
	/home/anirudh/Qt5.7.0/5.7/gcc_64/bin/rcc -name myres ../apertus_challenge/myres.qrc -o qrc_myres.cpp
...
main.o: ../apertus_challenge/main.cpp ../../Qt5.7.0/5.7/gcc_64/include/QtCore/QCoreApplication \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../apertus_challenge/main.cpp

lodepng.o: ../apertus_challenge/lodepng.cpp ../apertus_challenge/lodepng.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lodepng.o ../apertus_challenge/lodepng.cpp

debayer.o: ../apertus_challenge/debayer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o debayer.o ../apertus_challenge/debayer.cpp

qrc_myres.o: qrc_myres.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_myres.o qrc_myres.cpp
